...
func TestLoginUserInvalidUserJsonResponse(t *testing.T) {
	...
	rest.AddMockups(&rest.Mock{
		...
		RespBody:     `{"id": "1", "first_name": "Luciano", "last_name": "Ferrari", "email": "lucianodarioferrari@gmail.com"}`,
	})
...
func TestLoginUserNoError(t *testing.T) {
	...
	assert.EqualValues(t, "Luciano", user.FirstName)
	assert.EqualValues(t, "Ferrari", user.LastName)
	assert.EqualValues(t, "lucianodarioferrari@gmail.com", user.Email)
}
